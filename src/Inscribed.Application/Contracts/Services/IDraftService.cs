...
{
    Task SaveDraftAsync(string clientId, string? locale, string userId, string slug, IReadOnlyList<DraftBlock> blocks, CancellationToken cancellationToken = default);
